...
function AnalyticsBody({
  ...
  const opsCards = [
    ...
    { label: "Internal deliveries", value: String(t.internalDeliveryOrders ?? 0) },
  ...
  const financeCards = [
    ...
    { label: "Delivery costs", value: t.deliveryCosts > 0 ? formatPrice(t.deliveryCosts) : "—", hint: "Internal fleet cost (not tracked yet)" },
    {
      label: "3P delivery costs",
      value: t.thirdPartyDeliveryCosts > 0 ? formatPrice(t.thirdPartyDeliveryCosts) : "—",
      hint: "Shipday courier cost (not what the customer paid)",
    },
